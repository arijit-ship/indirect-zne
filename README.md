...
|                                     | **Warning**                       | String                               | **Warning**: Identity scaling for the U gate is supported only if the ansatz type is `'xy_model-xz-z'`. For other types, the identity scaling factor for the U gate must be set to `0`.                                        |
